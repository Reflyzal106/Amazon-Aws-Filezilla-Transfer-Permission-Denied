# [SOLVED] Amazon Aws Filezilla Transfer Permission Denied
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/amazon-aws-filezilla-transfer-permission-denied)

---

### 🔍 Quick Technical Overview & Summary:
Verify that the user running Filezilla has sudo privileges and ensure the /var/www/html directory is owned by the same user, then try again.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/amazon-aws-filezilla-transfer-permission-denied)**
